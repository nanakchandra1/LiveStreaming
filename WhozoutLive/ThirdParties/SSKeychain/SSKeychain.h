...
/**
 ...
 @param password1 password to store in the Keychain.
 ...
 */
+ (BOOL)setPassword:(NSString *)password1 forService:(NSString *)serviceName account:(NSString *)account;

/**
 Sets a password in the Keychain.
 
 @param password1 The password to store in the Keychain.
 ...
 @see setPassword:forService:account:error:
 */
+ (BOOL)setPassword:(NSString *)password1 forService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error;
