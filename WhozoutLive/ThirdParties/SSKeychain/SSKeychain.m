...
+ (BOOL)setPassword:(NSString *)password1 forService:(NSString *)service account:(NSString *)account {
	return [self setPassword:password1 forService:service account:account error:nil];
}


+ (BOOL)setPassword:(NSString *)password1 forService:(NSString *)service account:(NSString *)account error:(NSError **)error {
	OSStatus status = SSKeychainErrorBadArguments;
	if (password1 && service && account) {
